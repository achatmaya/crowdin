...
class LanguageRepository extends ServiceEntityRepository
{
    ...
    public function findProjectsByLanguage($languages)
    {
        ...
        $qb->where($qb->expr()->in('l', ':languages'));
        $qb->setParameter('languages', $languages);

        $qb->groupBy('p.id');
        $qb->having($qb->expr()->eq($qb->expr()->count('t'), count($languages)));
